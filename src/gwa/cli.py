...
from gwa.config import ProjectConfig
from gwa.tui import run_tui

# Import the Rust module - this will be available after building with maturin
try:
    from gwa import _core
except ImportError:
    _core = None
    print("Warning: Rust module not available. Please build with 'maturin develop'.")
...
@app.command()
def version() -> None:
    """Show the version of GWA CLI."""
    console.print("[bold]GWA CLI v0.1.0[/bold]")
    console.print(
